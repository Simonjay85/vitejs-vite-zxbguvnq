...
files.forEach(file => {
  ...
  content = content.replace(/border:"1px solid rgba\(0,255,178,0\.1\)"/g, 'border:`1px solid ${G.accent}`');
  content = content.replace(/background:"rgba\(0,255,178,0\.05\)"/g, 'background:G.lightAccent');
  content = content.replace(/background:"#00FFB2"/g, 'background:G.accent');
